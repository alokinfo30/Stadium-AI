...
class ModelManager:
    """Manages multiple models with fallback support for Stadium AI"""
    ...
    def __init__(self):
        ...
        self.app_name = os.getenv('OPENROUTER_APP_NAME', 'StadiumAI')
        ...
        self.agent_models = {
            'navigation': os.getenv('NAVIGATION_MODEL', self.primary_model),
            'crowd_management': os.getenv('CROWD_MANAGEMENT_MODEL', self.primary_model),
            'accessibility': os.getenv('ACCESSIBILITY_MODEL', self.primary_model),
            'transportation': os.getenv('TRANSPORTATION_MODEL', self.primary_model),
            'sustainability': os.getenv('SUSTAINABILITY_MODEL', self.primary_model),
            'multilingual': os.getenv('MULTILINGUAL_MODEL', self.primary_model),
            'operational': os.getenv('OPERATIONAL_INTELLIGENCE_MODEL', self.primary_model)
        }
